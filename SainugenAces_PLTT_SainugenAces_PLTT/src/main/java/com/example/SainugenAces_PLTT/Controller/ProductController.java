...
public class ProductController {
	...
	public ResponseEntity<Page<Product>> getProductsWithPagination(@PathVariable int offset,
		...
		if (productsWithPagination != null && !productsWithPagination.isEmpty()) {
			...
			System.out.println(
					"No products found for pagination request with offset: " + offset + " and pageSize: " + pageSize);
